...
This page explains how GyosJS is packaged for real use: CDN, npm, core versus auto-init, and standard versus strict-CSP builds.
...
The CSP build uses a restricted expression interpreter. Read [Content Security Policy](./content-security-policy.md) before switching an existing application.
...
- Pick the CSP variants if strict `script-src` compatibility justifies a restricted markup expression language and a larger runtime.
